...
**Smoking status** was the single strongest driver of charges: smokers were charged on average **£32,050** compared to **£8,434** for non-smokers — roughly 3.8x higher.

**BMI** had little effect on charges on its own, but became a powerful driver when combined with smoking status. Among smokers, those with BMI 30+ (obese) were charged **£41,558** on average versus **£21,363** for non-obese smokers — nearly double.
...
Obesity alone increased charges by only ~11% among non-smokers, but among smokers, obesity nearly doubled charges again — showing smoking and obesity compound each other's cost impact rather than simply adding together.
...
**Region** showed modest differences, with the Southeast averaging the highest charges (£14,700) compared to £12,300–13,400 elsewhere.
...
## Files
- `insurance_analysis.ipynb` — full analysis notebook with code, charts, and commentary
